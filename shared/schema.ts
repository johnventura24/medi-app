...
export const opsLookups = pgTable("ops_lookups", {
  ...
  agentName: text("agent_name"),
  agency: text("agency"),
  inputFirstName: text("input_first_name"),
  inputLastName: text("input_last_name"),
  inputDob: text("input_dob"),
  inputSsnMasked: text("input_ssn_masked"),
  carrier: text("carrier"),
  inputPlanId: text("input_plan_id"),
  mbiNumber: text("mbi_number"),
  claimNumber: text("claim_number"),
  fullName: text("full_name"),
  birthDate: text("birth_date"),
  dateOfDeath: text("date_of_death"),
  sex: text("sex"),
  partAEffective: text("part_a_effective"),
  partBEffective: text("part_b_effective"),
  currentPlanId: text("current_plan_id"),
  currentPlanName: text("current_plan_name"),
